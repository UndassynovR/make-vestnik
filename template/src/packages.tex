...
% Fallback: route Mathematical Alphanumeric Symbols block (U+1D400-1D7FF) through XITS Math.
% This catches any Unicode math chars (e.g. 𝛥 U+1D6E5) pasted into text by authors,
% preventing xdvipdfmx "Invalid font: -1" fatal crashes.
\setmathfont[range={"1D400-"1D7FF}]{XITS Math}

%See: https://tex.stackexchange.com/questions/201239/cant-get-unicode-symbols-in-math-mode
% Note: \familydefault already refers to Liberation Serif (set above), so no
% temporary \setmainfont switch is needed here.
